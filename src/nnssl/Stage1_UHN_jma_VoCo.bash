...
#nnUNet_n_proc_DA=1 nnssl_train 001 onemmiso -tr UHN_VoCoTrainer -p nnsslPlans -num_gpus 1
nnUNet_n_proc_DA=12 nnssl_train 001 onemmiso -tr UHN_VoCoTrainer -p nnsslPlans -num_gpus 4
