...
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_stage1/consistency_base-%j.out
#SBATCH --error=./logs_stage1/consistency_base-%j.err
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr Stage1_HuberMAETrainer_5_0_0_P192 -p nnsslPlans -num_gpus 2
