#!/bin/bash
#SBATCH --job-name=stage1-pretrain-DA
...
#     --openmind_root_dir '/scratch/kmin940d/FLARE_Task4_CT_FM/train_all' \
...
# stage1: HuberMAETrainer_BS24_5_0_0_DA
# stage2: UHN_Stage2NoProjMaxPool_BS24, UHN_Stage2_BS24
nnUNet_n_proc_DA=24 nnssl_train 001 onemmiso -tr HuberMAETrainer_BS24_5_0_0_DA -p nnsslPlans -num_gpus 4
