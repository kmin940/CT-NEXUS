#!/bin/bash
#SBATCH --job-name=stage2-outsize9
...
#nnUNet_n_proc_DA=12 nnssl_train 001 onemmiso -tr HuberMAETrainer_BS24_5_0_0 -p nnsslPlans -num_gpus 4
#nnUNet_n_proc_DA=1 nnssl_train 001 onemmiso -tr HuberMAETrainer_BS8_5_0_0 -p nnsslPlans -num_gpus 1

# AlignedHuberFTTrainer_BS24_From_Ckpt110_5_0_0
# AlignedHuberFTTrainer_MaxPool_BS24_From_Ckpt110_5_0_0
# nnUNet_n_proc_DA=12 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer_MaxPool_BS20_From_Ckpt110_5_0_0 -p nnsslPlans -num_gpus 4 \
#      -pretrained_weights /cluster/projects/bwanggroup/sumin/nnssl_data/nnssl_results/Dataset001_MerlinTrain/HuberMAETrainer_BS24_5_0_0__nnsslPlans__onemmiso/fold_all/checkpoint_epoch_110.pth

# AlignedHuberFTTrainer_BS24_DA_From_5_0_0
# AlignedHuberFTTrainer_BS24_MaxPool_DA_From_5_0_0
# AlignedHuberFTTrainer_BS24_ep200_DA_From_5_0_0
# AlignedHuberFTTrainer_BS24_MaxPool_DA_OutSize9_From_5_0_0
nnUNet_n_proc_DA=12 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer_BS24_MaxPool_DA_OutSize9_From_5_0_0 -p nnsslPlans -num_gpus 4 \
     -pretrained_weights /cluster/projects/bwanggroup/sumin/nnssl_data/nnssl_results/Dataset001_MerlinTrain/HuberMAETrainer_BS24_5_0_0_DA__nnsslPlans__onemmiso/fold_all/checkpoint_final.pth
