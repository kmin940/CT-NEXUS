#!/bin/bash
#SBATCH --job-name=AlignedHuberFTTrainer
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=2-00:00:00
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus/consistency_base_AlignedHuberFTTrainer-%j.out
#SBATCH --error=./logs_latentcampus/consistency_base_AlignedHuberFTTrainer-%j.err
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer -p nnsslPlans -num_gpus 2 \
     -pretrained_weights ${nnssl_results}/Dataset001_FLARE25_CT/HuberMAETrainer__nnsslPlans__onemmiso/fold_all/checkpoint_final.pth
