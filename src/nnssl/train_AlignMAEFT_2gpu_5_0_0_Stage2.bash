...
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.out
#SBATCH --error=./logs_latentcampus/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.err

# nohup bash train.bash > ./logs/S4.log 2>&1 &
mkdir -p ./logs_latentcampus
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr Stage2_AlignedHuberFTTrainer_From_5_0_0_P192 -p nnsslPlans -num_gpus 2 \
     -pretrained_weights ${nnssl_results}/Dataset001_FLARE25_CT/Stage1_HuberMAETrainer_5_0_0_P192__nnsslPlans__onemmiso/fold_all/checkpoint_epoch_550.pth
