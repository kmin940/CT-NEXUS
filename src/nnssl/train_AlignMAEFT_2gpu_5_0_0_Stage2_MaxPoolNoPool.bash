#!/bin/bash
#SBATCH --job-name=AlignedHuberFTTrainer_From_5_0_0
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=2-00:00:00
#SBATCH -c 32
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus_continue/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.out
#SBATCH --error=./logs_latentcampus_continue/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.err

# nohup bash train.bash > ./logs/S4.log 2>&1 &
mkdir -p ./logs_latentcampus_continue
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer_MaxPoolLossNoPoolNoContrast_B4_From_5_0_0 -p nnsslPlans -num_gpus 2 \
     -pretrained_weights ${nnssl_results}/Dataset001_FLARE25_CT/HuberMAETrainer_5_0_0__nnsslPlans__onemmiso/fold_all/checkpoint_final.pth --c
