#!/bin/bash
#SBATCH --job-name=NoRicianNoInvert
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=3-00:00:00
#SBATCH -c 32
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus_exp/NoRicianNoInvert-%j.out
#SBATCH --error=./logs_latentcampus_exp/NoRicianNoInvert-%j.err
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer_NoRicianNoInvert_B4_From_5_0_0 -p nnsslPlans -num_gpus 2 \
