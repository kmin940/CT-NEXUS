#!/bin/bash
#SBATCH --job-name=MaxPool-AlignMAEFT
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=3-00:00:00
#SBATCH -c 32
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus_exp/MaxPool-AlignMAEFT-%j.out
#SBATCH --error=./logs_latentcampus_exp/MaxPool-AlignMAEFT-%j.err
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr AlignedHuberFTTrainer_UseProj_MaxPool_From_5_0_0 -p nnsslPlans -num_gpus 2 \
