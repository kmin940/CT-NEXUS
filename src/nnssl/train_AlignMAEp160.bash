...
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus_p160/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.out
#SBATCH --error=./logs_latentcampus_p160/consistency_base_AlignedHuberFTTrainer_From_5_0_0-%j.err

# nohup bash train.bash > ./logs/S4.log 2>&1 &
mkdir -p ./logs_latentcampus_p160
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr _P192 -p nnsslPlans -num_gpus 2
