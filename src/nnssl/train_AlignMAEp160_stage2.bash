#!/bin/bash
#SBATCH --job-name=AlignedMAEFTTrainerP160
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=3-00:00:00
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus_p160_stage2/consistency_base_AlignedMAEFTTrainerP160-%j.out
#SBATCH --error=./logs_latentcampus_p160_stage2/consistency_base_AlignedMAEFTTrainerP160-%j.err
# nohup bash train.bash > ./logs/S4.log 2>&1 &
mkdir -p ./logs_latentcampus_p160_stage2
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr AlignedMAEFTTrainerP160 -p nnsslPlans -num_gpus 2 \
     -pretrained_weights ${nnssl_results}/Dataset001_FLARE25_CT/AlignedMAETrainerP160__nnsslPlans__onemmiso/fold_all/checkpoint_final.pth
