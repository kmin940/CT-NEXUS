#!/bin/bash
#SBATCH --job-name=huber
#SBATCH --account=aip-wanglab
#SBATCH --gres=gpu:l40s:2
#SBATCH --time=3-00:00:00
#SBATCH -c 24
#SBATCH --mem=60G
#SBATCH --output=./logs_latentcampus/huber-%j.out
#SBATCH --error=./logs_latentcampus/huber-%j.err
...
nnUNet_n_proc_DA=8 nnssl_train 001 onemmiso -tr HuberMAETrainer -p nnsslPlans -num_gpus 2 --c
